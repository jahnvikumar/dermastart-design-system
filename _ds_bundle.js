/* @ds-bundle: {"format":3,"namespace":"DermaStartDesignSystem_1e5d5c","components":[{"name":"Badge","sourcePath":"components/core/Badge.jsx"},{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"Card","sourcePath":"components/core/Card.jsx"},{"name":"Input","sourcePath":"components/core/Input.jsx"},{"name":"Navbar","sourcePath":"components/navigation/Navbar.jsx"}],"sourceHashes":{"components/core/Badge.jsx":"95b51a2be38b","components/core/Button.jsx":"04b28cf0aba1","components/core/Card.jsx":"00d587ff34f2","components/core/Input.jsx":"773d964a9aea","components/navigation/Navbar.jsx":"da8fbfec4943","ui_kits/website/image-slot.js":"9309434cb09c"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.DermaStartDesignSystem_1e5d5c = window.DermaStartDesignSystem_1e5d5c || {});
...
function Badge({
  ...
  return React.createElement('span', {
    style
  }, [variant === 'trust' && sageSVG, icon && variant !== 'trust' && icon, children].filter(Boolean));
}
...
function Input({
  ...
  const inputStyle = {
    ...
    width: '100%',
    background: '#FFFFFF',
    border: error ? '1.5px solid #C0605A' : focused ? '1.5px solid #C9A882' : '1px solid #E8D5C4',
    borderRadius: '4px',
    padding: '12px 16px',
    fontFamily: "'DM Sans', system-ui, sans-serif",
    fontSize: '15px',
...
function Navbar({
  ...
  return React.createElement('nav', {
    ...
    style: ctaStyle,
    onMouseEnter: e => {
      e.currentTarget.style.background = '#B5935F';
    },
    onMouseLeave: e => {
      e.currentTarget.style.background = '#C9A882';
    }
  }, ctaLabel)]));
}
